...
public class JavaScalars {
    ...
    public static GraphQLScalarType GraphQLLocalDateTime =
        GraphQLScalarType.newScalar().name("LocalDateTime")
    ...
    public static GraphQLScalarType GraphQLLocalDate =
        GraphQLScalarType.newScalar().name("LocalDate")
            .description("Date type")
            .coercing(new Coercing() {
                @Override
                public Object serialize(Object input) {
    ...
    public static GraphQLScalarType GraphQLDate =
        GraphQLScalarType.newScalar().name("Date")
            .description("Date type")
            .coercing(new Coercing() {
                @Override
                public Object serialize(Object input) {
    ...
    public static GraphQLScalarType GraphQLUUID =
        GraphQLScalarType.newScalar().name("UUID")
